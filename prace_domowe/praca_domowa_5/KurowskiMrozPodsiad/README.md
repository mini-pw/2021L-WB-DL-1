...
Wyniki są całkiem zadowalające biorąc pod uwagę możliwości naszego sprzętu i to, że sieć była trenowana na 3000 zdjęć przez 400 epok. Kod do trenowania znajduje się w pliku *gan_training/GAN.ipynb*.
