...
parser.add_argument('--covid_weight', default=1., type=float, help='Class weighting for covid') #bylo 4 #a wzialem 2 do under over samplingu
...
model1 = keras_model_build()
model2 = buildModel()
model2.trainable = False

model = keras.Model(inputs=model2.input, outputs=model1.output)
...
model.save('models/model_org.h5')
