...
from tensorflow.keras.layers import Conv2D, Input, MaxPool2D, add, Flatten, Dense, DepthwiseConv2D, BatchNormalization
...
def keras_model_build(input_size=(224, 224, 3)):
    ...
    p_2_y = BatchNormalization()(p_2_y)
    ...
    p_3_y = BatchNormalization()(p_3_y)
    ...
    p_4_y = BatchNormalization()(p_4_y)
