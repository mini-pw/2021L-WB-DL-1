...
def VGG19_l1_and_l2(input_shape=None,classes=5, use_soft=True):
    ...
    x = layers.Dense(512, activation='relu', name='fc1',
                   kernel_regularizer=regularizers.l1_l2(l1=1e-5, l2=1e-4),
                    ...
                    activity_regularizer=regularizers.l1_l2(l1=1e-5, l2=1e-4))(x)
    x=layers.Dropout(0.5)(x)

    x = layers.Dense(128, activation='relu', name='fc2',
                   kernel_regularizer=regularizers.l1_l2(l1=1e-5, l2=1e-4),
                    bias_regularizer=regularizers.l1_l2(l1=1e-5, l2=1e-4),
                    activity_regularizer=regularizers.l1_l2(l1=1e-5, l2=1e-4))(x)
    #x=layers.Dropout(0.8)(x)
    ...
    if use_soft:
        ...
        x = Dense(classes, activation = "linear", name = "Z_4",
                   kernel_regularizer=regularizers.l1_l2(l1=1e-5, l2=1e-4),
                    bias_regularizer=regularizers.l1_l2(l1=1e-5, l2=1e-4),
                    activity_regularizer=regularizers.l1_l2(l1=1e-5, l2=1e-4))(x)
...
def VGG19_l1(input_shape=None,classes=5, use_soft=True):
