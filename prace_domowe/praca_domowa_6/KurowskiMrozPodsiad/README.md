...
Pomimo prób nie udało się uruchomić explAInera. Po pobraniu repo z githuba i włączeniu komendy, która według readme miałaby skonstruować aplikację, występują błędy z brakiem plików. Niestety próby lepszego zrozumienia wyświetlanego błędu nie przyniosły pozytywnego rezultatu. Z tego powodu podjęliśmy próbę skorzystania z wyjaśnień wykorzystywanych przez explAIner tworząc odpowiednie explainery w kodzie. Te niestety wciąż nie działały prawidłowo Problemy występowały m.in. dlatego, bo wygenerowany model nie zawierał funkcji softmax, model był uczony na danych 3d, a nie 2d lub wymagana była paczka DeepExplain od tensorflow. Po jej dołączeniu nie jest ona prawidłowo zauważana przez odpowiednie funkcje.  
